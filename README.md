...
4. [Deploy your app with Github Actions](https://github.com/prof-tejera/react-deployment-code#github-actions) and insert the url here: REPLACE_WITH_URL_TO_APP  (JESSDEV)
